...
const Navbar = () => {
    ...
    return (
        <header
            className={`fixed w-full top-0 left-0 flex justify-center items-center z-[99] py-1 px-0 transition duration-500 bg-white head ${visible ? '' : 'hidden'}`}
            style={{ display: 'flex' }}
        >
            <nav className="flex w-[85%] justify-between items-center">
                ...
                <div className="nav__menu-list">
                    <div>
                        <button className="nav__link" target="_blank" style={{ color: 'black' }} rel="noreferrer">
                            MakeMyWeb.
                        </button>
                    </div>
                    <div>
                        <Link className="gradient-text nav-link active" aria-current="page" to="">
                            Home
                        </Link>
                    </div>
                    <div>
                        <Link className="text-black nav-link active" aria-current="page" to="">
                            Company
                        </Link>
                    </div>
                    <div>
